...
#include "../../../cell/attendancewindow.h"
...
struct qt_meta_stringdata_CLASSAttendanceWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAttendanceWindowENDCLASS = QtMocHelpers::stringData(
    "AttendanceWindow",
    "query",
    "",
    "cv::Mat&",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAttendanceWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AttendanceWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAttendanceWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAttendanceWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAttendanceWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AttendanceWindow, std::true_type>,
        // method 'query'
...
void AttendanceWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->recevice_faceID((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1]))); break;
        ...
        {
            using _t = void (AttendanceWindow::*)(cv::Mat & );
            if (_t _q_method = &AttendanceWindow::query; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AttendanceWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAttendanceWindowENDCLASS.stringdata0))
...
// SIGNAL 0
void AttendanceWindow::query(cv::Mat & _t1)
{

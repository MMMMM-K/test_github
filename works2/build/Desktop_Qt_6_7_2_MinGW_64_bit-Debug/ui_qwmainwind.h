...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setShortcutContext(Qt::ShortcutContext::WidgetWithChildrenShortcut);
        ...
        QObject::connect(actAbout, &QAction::triggered, txtEdit, qOverload<>(&QTextEdit::show));
...
#if QT_CONFIG(tooltip)
        actAbout->setToolTip(QCoreApplication::translate("QWMainWind", "\346\230\276\347\244\272\344\277\241\346\201\257", nullptr));
#endif // QT_CONFIG(tooltip)
